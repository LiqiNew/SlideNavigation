...
public class PagerSlidingTabStrip extends HorizontalScrollView implements
	...
	// 用来做textView文字是否变大，默认是当前选择的textView字体不会变大
	public boolean textSizeTag = false;
	// 对象是否可以滑动,默认可以滑动
	public boolean slidingTag = true;
	...
	/**
	 * 设置currentSelectedTabView如果是TextView的字体尺寸
	 * 
	 * @param size
	 */
	private void setTextViewSize(int size) {
		if (currentSelectedTabView instanceof TextView) {
			TextView textView = (TextView) currentSelectedTabView;
